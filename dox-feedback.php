...
// sigue en pie con su propio menú en vez de tumbar el sitio con un error fatal.
if ( file_exists( DXF_DIR . 'dox-core/loader.php' ) && file_exists( DXF_DIR . 'dox-core/version.php' ) ) {
